                    ...
                    {activeTab === 'intel' && (
                        <div className="space-y-6">
                            ...
                            <div className="logistics-card">
                                ...
                                <div className="space-y-4">
                                    <div className="logistics-item">
                                        <div className="icon-box bg-orange-500/20 text-orange-400"><HardHat size={20} /></div>
                                        <div className="w-full">
                                    ...
                                    <div className="logistics-item">
                                        <div className="icon-box bg-blue-500/20 text-blue-400"><Shield size={20} /></div>
                                        <div className="w-full">
                                    ...
                                    <div className="logistics-item">
                                        <div className="icon-box bg-slate-500/20 text-slate-400"><MapPin size={20} /></div>
                                        <div className="w-full">
                            ...
                            <div className="competitor-intel mt-6">
                                <h4 className="text-sm font-bold text-slate-400 mb-3 uppercase">Hiring Insights</h4>
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="intel-box glass-panel p-3 text-center">
                                        <div className="text-xs text-slate-500 uppercase">Time to Hire</div>
                                        {isEditing ? (
                                            <input
                                            ...
                                            <div className="text-lg font-bold text-white">{localClient.hiringInsights?.avgTimeToHire || "N/A"}</div>
                                        )}
                                    </div>
                                    <div className="intel-box glass-panel p-3 text-center">
                                        <div className="text-xs text-slate-500 uppercase">Most Hired</div>
                                        {isEditing ? (
                                            <input
                                                className="edit-input small text-center mt-1"
                                            ...
                                            <div className="text-lg font-bold text-white">{localClient.hiringInsights?.mostHiredRole || "N/A"}</div>
                                        )}
                                    </div>
                                    <div className="intel-box glass-panel p-3 text-center">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <div className="text-xs font-medium text-white mt-1">{localClient.hiringInsights?.commonFeedback || "N/A"}</div>
                                        )}
                                    </div>
                                </div>
                            </div>
