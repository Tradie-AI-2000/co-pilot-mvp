...
import { ArrowRight, Coffee, AlertTriangle, Zap, Sparkles, CheckCircle, ShieldAlert, HeartCrack } from "lucide-react";
    ...
    return (
        <div className={`focus-card ${signalClass}`} onClick={onAction}>
            ...
            <style jsx>{`
                ...
                .focus-card.retention { border-left-color: #f97316; }
